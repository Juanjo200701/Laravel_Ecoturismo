...
<body>
    <div class="contenedor-detalle">
        ...
        <div class="galeria">
            <img src="imagenes/kaukita8.jpg" alt="Kaukitá Bosque Reserva" class="imagen-principal">
            <div class="miniaturas">
                <img src="imagenes/kaukita2.jpg" alt="Senderos" class="miniatura">
                <img src="imagenes/kaukita3.jpg" alt="Flora" class="miniatura">
                <img src="imagenes/kaukita4.jpg" alt="Paisaje" class="miniatura">
            </div>
        </div>
